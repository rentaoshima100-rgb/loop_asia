...
const PAGE_META = {
  home:        { title: "亜細亜交流事業協同組合 ｜ 育成就労・特定技能の受入を一貫支援（日本語学校併設）",
                 desc: "監理支援機関として、育成就労・特定技能による外国人材の受入を、入国前の日本語教育から定着まで一貫支援。グループ内で日本語学校を運営し、登録支援機関を保有。アジア9カ国に対応します。" },
  ...
  tokutei:     { title: "特定技能制度 ｜ 亜細亜交流事業協同組合",
                 desc: "特定技能制度による即戦力人材の受入を、グループ内登録支援機関が法定10項目の支援も含めて一貫サポート。19の特定産業分野に対応します。" },
  ...
  cases:       { title: "活躍事例 ｜ 亜細亜交流事業協同組合",
                 desc: "受入企業の現場で活躍する外国人材の事例と本人の声。対応送出国9カ国、特定産業19分野、累計受入実績1,821人。" },
